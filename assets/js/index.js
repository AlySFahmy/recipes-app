...
function closeNav() {
    ...
    $('.nav-menu').html('<i class="fa-solid fa-bars"></i>');
}
    ...
    for (let [key, value] of Area) {
        term += `
         ...
         <div onclick="filterByArea('${value.strArea}')" class="item overflow-hidden position-relative text-center py-5">
            ...
            <i class="fa-regular fa-face-grin-tongue fa-3x "></i>
...
function displayIngredients(Data) {
    ...
    for (let [key, value] of ingredients) {
        term += `
         ...
         <i class="fa-solid fa-skull-crossbones fa-3x"></i>
...
{
    let term = `
    <h2 class="text-center">Contact Us لو جدع!!</h2>
    <form>
        <div class="row mt-3 ms-5">
            <div class="col-md-6">
                <input type="text" required id="name" maxlength="37" class="form-control mt-4 bg-white rounded text-dark" placeholder="Your Name Yad!">
                <span Class="error" class="animate__animated"></span>
            </div>
            <div class="col-md-6">
                <input type="email" required id="email"  class="form-control mt-4 bg-white rounded text-dark" placeholder="Your Email Yad">
                <span Class="error" class="animate__animated"></span>
            </div>
            <div class="col-md-6">
                <input type="number"required id="phone" class="form-control mt-4 bg-white rounded text-dark" placeholder="Your Phone Yad">
                <span Class="error" class="animate__animated"></span>
            </div>
            <div class="col-md-6">
                <input type="number"required id="age"  class="form-control mt-4 bg-white rounded text-dark" placeholder="What's Your Age Yad?">
                <span Class="error" class="animate__animated"></span>
            </div>
            <div class="col-md-6 position-relative">
                <input type="password" required id="password" class="form-control mt-4 bg-white rounded text-dark" placeholder="Your Password">
                <span Class="error" class="animate__animated"></span>
                <span class="showPass"><i data-show="show" class="fa-solid fa-eye-slash"></i></span>
            </div>
            <div class="col-md-6">
                <input type="password"required id="repassword" class="form-control mt-4 bg-white rounded text-dark" placeholder="Tany Yad">
                <span Class="error" class="animate__animated"></span>
            </div>
